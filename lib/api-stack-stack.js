...
class ApiStack extends Stack {
  ...
  constructor(scope, id, props) {
    ...
    // const registerRole = new iam.Role(this, "RegisterFunctionRole", {
    //   roleName: "RegisterFunction",
    ...
    const meFn = new nodeLambda.NodejsFunction(this, "Me", {
      functionName: "meFn",
    ...
    api.root
      .resourceForPath("signin") // POST /instances
      .addMethod("ANY", new apiGateway.LambdaIntegration(signInFn));

    api.root
      .resourceForPath("me") // ALL /me
      .addMethod("ANY", new apiGateway.LambdaIntegration(meFn), { authorizer });
