...
class ApiStack extends Stack {
  ...
  constructor(scope, id, props) {
    ...
    const pyLayer = new lambda.LayerVersion(this, "MyLayer", {
      code: lambda.Code.fromAsset("lib/lambdas/test", {
        bundling: {
          ...
          command: [
            "bash",
            "-c",
            "pip install -r requirements.txt -t .build/python && rm -rv .build/python/*.dist-info && find .build/python -path '*/__pycache__/*' -delete && cp -av .build/python /asset-output",
          ],
        },
      }),
    });
    ...
    const pyFn = new lambda.Function(this, "Test", {
      ...
      code: lambda.Code.fromAsset("lib/lambdas/test", {
        bundling: {
          image: lambda.Runtime.PYTHON_3_11.bundlingImage,
          command: ["bash", "-c", "cp -av test.py /asset-output"],
        },
      }),
      role: pyRole,
      layers: [pyLayer],
